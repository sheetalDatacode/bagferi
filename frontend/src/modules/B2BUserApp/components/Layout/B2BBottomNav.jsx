...
import { FiHome, FiGrid, FiBriefcase, FiVideo, FiUser, FiShoppingBag, FiShoppingCart } from 'react-icons/fi';
...
const B2BBottomNav = () => {
    ...
    const navItems = [
        ...
        { icon: FiShoppingCart, label: 'Grocery', path: '/b2b/grocery', requireAuth: false },
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 z-[100] lg:hidden shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
