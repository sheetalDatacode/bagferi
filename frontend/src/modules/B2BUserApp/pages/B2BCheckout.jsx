            ...
            <div className="max-w-5xl mx-auto w-full px-4 md:px-6 pt-6">
                <div className="flex bg-white rounded-2xl p-1 shadow-sm border border-gray-100 max-w-sm">
                    <button
                        ...
                        className={`flex-1 py-2 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all ${cartTab === 'fashion'
                    ...
                    <button
                        ...
                        className={`flex-1 py-2 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all ${cartTab === 'grocery'
