...
const searchStr = `    const [citySearchQuery, setCitySearchQuery] = useState('');
...
const replacementStr = `    const [citySearchQuery, setCitySearchQuery] = useState('');
    const [categorySearchQuery, setCategorySearchQuery] = useState('');
...
if (content.includes(searchStr)) {
    ...
    console.log("Could not find the target string! Current content slice:");
    console.log(content.substring(content.indexOf('const [citySearchQuery'), content.indexOf('const speed = 150;') + 50));
}
